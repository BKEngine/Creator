...
/*//		return dic;*/	RETURNDEFAULT;
	...
	{
//		MINIMUMPARAMNUM(1);
/*//		return self->equals(PARAM(0));*/	RETURNDEFAULT;
	}
...
//		}
//		else
/*//			return BKE_Variable();*/	RETURNDEFAULT;
	}
...
/*//		return (getutime() - start) / 1000 ;*/	RETURNDEFAULT;
	}

	NATIVE_FUNC(clock)
	{
/*//		return getutime() / 1000;*/	RETURNDEFAULT;
	}
	//range(a)-->[0,1,2,...,a-1]
...
//		} while (per == 1.f);
/*//		return (bkplong)(a+(b-a)*per);*/	RETURNDEFAULT;
	}
...
//		MINIMUMPARAMNUM(1);
//		bkplong a = PARAM(0);
/*//		return bkpInt2Str(a);*/	RETURNDEFAULT;
	}
...
/*//		}*/	RETURNDEFAULT;
	...
	NATIVE_FUNC(hash16)
	{
/*//		return (bkplong)nativeFunc_hash(self, paramarray, _this) & 0xFFFF;*/	RETURNDEFAULT;
	}
...
//		if (!re)
//			throw Var_Except(L"打开文件失败");
/*//		return Parser::getInstance()->eval(res);*/	RETURNDEFAULT;
	}
...
//		if (off < 0)
//			return false;
/*//		return wcscmp(src + off, dst)==0;*/	RETURNDEFAULT;
	}
...
/*//		return s;*/	RETURNDEFAULT;
	...
	{
/*//		return self->str.toLowerCase();*/	RETURNDEFAULT;
	}

	NATIVE_FUNC(toUpperCase)
	{
/*//		return self->str.toUpperCase();*/	RETURNDEFAULT;
	}
...
//		else
/*//			return self->str.substr((bkplong)PARAM(0));*/	RETURNDEFAULT;
	}
...
//			}
//		}
/*//		throw Var_Except(L"只能用于字符串、数组或字典类型");*/	RETURNDEFAULT;
	}
...
//			RETURNDEFAULT;
//		}
/*//		throw(Var_Except(L"字典的update操作需要右操作数为一个字典。"));*/	RETURNDEFAULT;
	}
...
//			RETURNDEFAULT;
//		}
/*//		throw(Var_Except(L"字典的except操作需要右操作数为一个字典。"));*/	RETURNDEFAULT;
	}

	NATIVE_FUNC(toArray)
	{
/*//		return ((BKE_VarDic*)self->obj)->toArray();*/	RETURNDEFAULT;
	}
...
#define CURRENTCLASS Date
	...
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_year + 1900;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(getMonth)
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_mon + 1;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(getDay)
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_mday;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(getHour)
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_hour;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(getMinute)
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_min;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(getSecond)
	{
//		GETINSTANCE();
/*//		return instance->_tm->tm_sec;*/	RETURNDEFAULT;
	}
...
#define CURRENTCLASS Math
	...
	NATIVECLASS_GET(PI)
	{
/*//		return M_PI;*/	RETURNDEFAULT;
	}

	NATIVECLASS_GET(E)
	{
/*//		return M_E;*/	RETURNDEFAULT;
	}
...
//		if (a > 0)
//			return 1;
/*//		return -1;*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(abs)
	{
//		MINIMUMPARAMNUM(1);
/*//		return fabs(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(sqrt)
	{
//		MINIMUMPARAMNUM(1);
/*//		return sqrt(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(lg)
	{
//		MINIMUMPARAMNUM(1);
/*//		return log10(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(ln)
	{
//		MINIMUMPARAMNUM(1);
/*//		return log(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}
	...
	{
//		MINIMUMPARAMNUM(2);
/*//		return log(PARAM(1).asNumber())/log(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(floor)
	{
//		MINIMUMPARAMNUM(1);
/*//		return floor(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(ceil)
	{
//		MINIMUMPARAMNUM(1);
/*//		return ceil(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(round)
	{
//		MINIMUMPARAMNUM(1);
/*//		return (bkplong)((double)PARAM(0)+0.5);*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(sin)
	{
//		MINIMUMPARAMNUM(1);
/*//		return sin(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(cos)
	{
//		MINIMUMPARAMNUM(1);
/*//		return cos(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(tan)
	{
//		MINIMUMPARAMNUM(1);
/*//		return tan(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(asin)
	{
//		MINIMUMPARAMNUM(1);
/*//		return asin(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(acos)
	{
//		MINIMUMPARAMNUM(1);
/*//		return acos(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}

	NATIVECLASS_FUNC(atan)
	{
//		MINIMUMPARAMNUM(1);
/*//		return atan(PARAM(0).asNumber());*/	RETURNDEFAULT;
	}
...
/*//		return distribution(engine);*/	RETURNDEFAULT;
	}
...
//		GETINSTANCE();
//		MINIMUMPARAMNUM(1);
/*//		return std::regex_match((wstring)PARAM(0), instance->reg);*/	RETURNDEFAULT;
	}
...
//		wstring rpl = PARAM(1);
//		replace(rpl, m);
/*//		return m.prefix().str() + rpl + m.suffix().str();*/	RETURNDEFAULT;
	}
